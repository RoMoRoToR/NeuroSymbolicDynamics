...
- Article group: quasi-periodic
- Public source: <https://www.kaggle.com/datasets/rakannimer/air-passengers>
- Notes:
...
- Public source: <https://www.kaggle.com/datasets/novandraanugrah/bitcoin-historical-datasets-2018-2024>
- Notes:
...
- Article group: intermediate / regime-switching
- Public source page used for acquisition reference: <https://www.kaggle.com/datasets/amananandrai/complete-eeg-dataset>
- Notes:
...
- External reference dataset page: <https://www.kaggle.com/datasets/henrychibueze/lorenz-attractor-dataset>
- Example command:
...
- Notes:
  ...
  - the canonical Lorenz files in this repository are generated by `scripts/generate_lorenz_data.py`, not downloaded from Kaggle
